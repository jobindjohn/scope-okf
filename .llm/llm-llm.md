...
**Change:** Created llm.md by extracting the LLM provenance section from scope-okf.md and expanding it into a full field-style note (what it's for, inline vs. sidecar, the 1→2 migration, `.llm/` folder rules, `llm-log` format, boundary with log.md, conformance).
