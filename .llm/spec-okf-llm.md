...
**Change:** Extracted the `## Linking` section into a standalone [linking.md](/linking.md), replacing it in spec-okf.md with a three-paragraph summary plus a link (same pattern as the earlier llm.md extraction). The `aliases` frontmatter definition stayed in spec-okf.md.
